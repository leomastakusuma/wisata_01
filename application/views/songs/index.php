<div class="container">
    ...
    <?php
        if(!empty($flash_msg)){
            ...
            // }
           // die;
           ?><div class="where-are-we-box"><?php
                echo $flash_msg;?>
           </div> 
           <?php 
        }
    ...
    <div>
        ...
        <form action="<?php echo URL; ?>songs/addsong" method="POST">
            <label>Artist</label>
            <input type="text" name="artist" value="<?php if(isset($artist)) echo $artist?>" required />
            <label>Track</label>
            <input type="text" name="track" value="<?php if(isset($tract)) echo $tract;?>" required />
            <label>Link</label>
